...
export const MODULOS_CATALOGO_REPOSITORY = Symbol('MODULOS_CATALOGO_REPOSITORY');
...
export interface ModulosCatalogoRepository {
  ...
  actualizar(id: string, input: ActualizarModuloInput, usuarioEdicion: string): Promise<Modulo>;
  cambiarEstado(id: string, estado: 0 | 1, usuarioEdicion: string): Promise<Modulo>;
}
