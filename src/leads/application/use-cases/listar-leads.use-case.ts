...
import { inicioDiaLimaUtc, finDiaLimaUtc } from '../../../shared/application/lima-time';
...
export class ListarLeadsUseCase {
  ...
  execute(organizacionId: string, input: ListarLeadsInput) {
    return this.leads.listar(organizacionId, {
      ...
      fechaDesde: input.fechaDesde ? inicioDiaLimaUtc(input.fechaDesde) : undefined,
      fechaHasta: input.fechaHasta ? finDiaLimaUtc(input.fechaHasta) : undefined,
      page: input.page,
