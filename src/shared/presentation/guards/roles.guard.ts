...
import type { RolOrganizacion, RequestContext } from '../../../auth/domain/request-context.interface';
...
export class RolesGuard implements CanActivate {
  ...
  canActivate(context: ExecutionContext): boolean {
    const rolesRequeridos = this.reflector.getAllAndOverride<RolOrganizacion[]>(ROLES_KEY, [
      context.getHandler(),
      context.getClass(),
    ]);
